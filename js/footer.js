...
function renderFooter() {
    const footer = `    <footer class="bg-dark text-light py-4 mt-5">
        <div class="container">
            <div class="row">
            ...
            <div class="text-center mt-4 pt-4 border-top border-secondary">
                <p class="mb-0 text-light">&copy; ${new Date().getFullYear()} Confab Web Oasis. Tất cả các quyền được bảo lưu.</p>
            </div>
        </div>
    </footer>`;
